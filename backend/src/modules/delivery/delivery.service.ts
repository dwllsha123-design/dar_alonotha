  ...
  async upsertZone(dto: UpsertDeliveryZoneDto) {
    ...
    return this.prisma.deliveryZone.upsert({
      ...
      create: {
        ...
        maleEnabled: dto.maleEnabled ?? true,
        femaleEnabled: dto.femaleEnabled ?? true,
      ...
      update: {
        maleFee: dto.maleFee,
        femaleFee: dto.femaleFee,
        ...(dto.maleEnabled != null ? { maleEnabled: dto.maleEnabled } : {}),
        ...(dto.femaleEnabled != null ? { femaleEnabled: dto.femaleEnabled } : {}),
        isActive: dto.isActive ?? true,
