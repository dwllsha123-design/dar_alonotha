      ...
      if (res.fulfillmentType === 'INTERNAL') {
        ...
        setMsg(
          code
            ...
            : 'تم إرسال الطلب لشركة المعيار بالحساب العام',
        );
      }
      await load();
    } catch (err) {
    ...
    <div className="stack">
      <div className="topbar">
        <div className="page-title">
          <h1>التوصيل</h1>
          <p>
            من هنا تنظّمين شحن الطلبات: طرابلس عبر المناديب المحليين، وخارجها عبر المعيار بالحساب
            العام للموقع تلقائياً. يمكن أيضاً إعادة توجيه طلب يدوياً وطباعة البوليصات.
          </p>
        </div>
